    ...
    try {
      const response = await fetch("/api/did/vc/issue", {
        ...
        body: JSON.stringify({
          ...
          credentialType: "BankingCredential",
          claims: { docId, status: "Verified", institution: "Central Bank" },
          expiryDays: 365
        })
      });
                      ...
                      <TableCell>
                        <a href={doc.file_url} target="_blank" rel="noopener noreferrer">
                          <Button variant="outline" size="sm" className="text-blue-600">
                            <FileText className="h-4 w-4 mr-2" /> View Inline <ExternalLink className="h-3 w-3 ml-1" />
                          </Button>
                        </a>
                      </TableCell>
